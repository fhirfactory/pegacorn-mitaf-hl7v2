package net.fhirfactory.pegacorn.mitaf.hl7v2.platform.transform.fhir2hl7;
...
public class CreatePV1Segment extends BaseHL7SegmentCreator {
	...
	public Segment create(Bundle source) throws HL7Exception {
		...
		return (Segment) message.get("PV1");
	}
}
